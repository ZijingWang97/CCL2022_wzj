...
def parse_args():
    ...
    # Path options.
    parser.add_argument("--data_path", type=str, default='datasets/CCL2022', help="Path of the dataset.")
    parser.add_argument("--test_path", type=str, default='datasets/CCL2022/data/test.json', help="Path of the testset.")
    ...
    parser.add_argument("--output_result_path", type=str, default='models_save/results_conf.json')
    parser.add_argument("--output_model_path", default="./models_save/model.bin", type=str, help="Path of the output model.")

    parser.add_argument("--model_name_or_path", default="hfl/chinese-bert-wwm-ext", type=str, help="Path of the output model.")
    ...
    parser.add_argument("--lr_task", type=float, default=5e-5, help="Learning rate for task layers.")
