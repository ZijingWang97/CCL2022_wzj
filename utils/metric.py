...
def score(preds_tuple, golds_tuple):
    ...
    '''
    gold_mention_n, pred_mention_n, true_positive_n ,false_positive_n= 0, 0, 0,0
    for sentence_id in golds_tuple:
        ...
        for mention in pred_sentence_mentions:
            if mention in gold_sentence_mentions:
                true_positive_n += 1
            if mention not in gold_sentence_mentions:
                # print(sentence_id,mention)
                false_positive_n += 1
    # print(true_positive_n,false_positive_n,pred_mention_n, gold_mention_n)            
