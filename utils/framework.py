...
class Framework(object):
    ...
    def evaluate_with_oracle(self, config, model, dev_data_loader, device, ty_args_id, id2type):
        ...
        # print(args_pred_tuples_dict, args_truth_tuples_dict)
        # for everykey in args_truth_tuples_dict.keys():
        #     del 
        # print(len(args_pred_tuples_dict), len(args_truth_tuples_dict))
